...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_turnout > largest_county_count) and (turnout_percent > largest_county_percent):
            largest_county_count = votes_turnout
            largest_county_name = county_name
            largest_county_percent = turnout_percent
